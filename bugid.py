...
def getbugid(progname, stacktrace, vulntype,filename):
    assert isinstance(stacktrace, str)
    print('filename:',filename,'vulntype:',vulntype)
    if vulntype == "???":
        return -1
    # if progname == "mp3":
    #     progname = "mp3gain"
...
if __name__ == "__main__":
    ...
    print(getbugid(progname, stacktrace, vulntype,filename=None))
